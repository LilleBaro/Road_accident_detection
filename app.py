...
selected = option_menu(
    menu_title="M E N U",
    options=["Home","A propos", "Detection d'accidents", "Detection d'objet","Detection en temps réel"],
    icons=["house", "info-circle","exclamation-triangle","camera","play-circle"],
    menu_icon="cast",
    default_index=0,
...
elif selected == "Detection d'objet":

    def run_detection_objet():
        import tempfile
        import os
        import time
        import cv2
        ...
        st.markdown("""
        <div style="background:#1f4e79; padding:12px; border-radius:8px; color:white;">
            <h2 style="margin:0">🚨 Détection d'objet</h2>
            <p style="margin:0.25rem 0 0 0; color:#F0F2D6;">Uploadez une image ou une vidéo pour la détection d'objet.</p>
        </div>
        """, unsafe_allow_html=True)
